...
crew_2_matched_flights: Dict[int, Set[int]] = defaultdict(set)
flight_2_matched_crews: Dict[int, Set[int]] = defaultdict(set)
crew_id_2_crew: Dict[int, Crew] = {}
layover_bases: Set[str] = set()
ground_id_2_ground: Dict[int, GroundDuty] = {}
bus_id_2_bus: Dict[int, BusTravel] = {}
